...
There are two other files with sample graphs, to help get a feel what these distributions look like, and also to appreciate how this disease is progressing at different phases and rates in various countries. One is global, the other contains Texas points of interest and New York City. If you are on a phone, you need to go to tab that says "View Code" to see these files.
